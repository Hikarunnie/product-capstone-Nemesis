...
|------|------|-----------------|
| Product Owner | Ani Kharabadze | Owns and orders the backlog. Accepts or rejects sprint increments. Reviews AI-generated features against user interview evidence. |
| Scrum Master (Sprint 1) | Ketevan Shavadze | Facilitates standups, planning, review, and retrospective. Runs AI output review at each standup. Maintains ai-usage-log.md currency. |
| Scrum Master (Sprint 2) | Tamar Vatcharadze | Rotates after Sprint 1. |
...
4. **Security and privacy check:** For any endpoint, form, or data-handling code, confirm no security vulnerability and no PII in logs or storage. All user identification must use UUID — never email or name.
...
| Story | Assigned Developer | AI Reviewer |
|-------|--------------------|-------------|
| S1-01 Signup | Ani Kharabadze | Ketevan Shavadze |
| S1-02 Listing form | Tamar Vatcharadze | Ani Kharabadze |
| S1-03 Image upload | Ani Kharabadze | Tamar Vatcharadze |
| S1-04 Confirmation screen | Gvantsa Nozadze | Ketevan Shavadze |
| S1-05 My Studio dashboard | Gvantsa Nozadze | Ani Kharabadze |

Review must be completed within 24 hours of the PR being raised. The reviewer checks: logic correctness, AC compliance, annotation quality, ai-usage-log entry, and no PII in storage or logs.

### AI Tool Assignment

| Story Type | Default AI Tool | Why |
|-----------|----------------|-----|
| UI screens and components | Google AI Studio | Fastest path from AC to working UI for our stack |
...
Examples:
```
feature/s1-01-user-signup
feature/s1-02-listing-form
fix/s1-03-image-upload-validation
```
...
5. Ani Kharabadze (PO) confirms AC met — in PR comments or at standup
6. Reviewer merges — not the original developer

### No direct pushes to main

Any commit pushed directly to `main` without a PR review is a process violation. Ketevan Shavadze flags it at the next standup.
...
**Who posts:** Every team member posts independently. If a member has not posted by 11:00, Ketevan Shavadze flags it at the next standup as a process issue.
...
|-------------|-------------|------------------------|
| Technical (code, environment) | Post in standup with specific description | Ketevan Shavadze escalates to whole team in teams |
...
| External dependency (API, third party) | Note in risk register | Ani Kharabadze adjusts sprint scope if unresolved by Day 5 |
...
|----------|------------|-------------------|--------|
| Sprint Planning | Ketevan Shavadze | All team members | Committed sprint backlog with AC, assignees, AI tools |
| Daily Standup | Async — no facilitator | All team members post | Blockers surfaced, coordination confirmed, AI output reviewed |
| Sprint Review | Ani Kharabadze | All team members | PO accepts or rejects each story. Backlog updated. |
| Retrospective | Ketevan Shavadze | All team members | 1 to 3 concrete process changes for next sprint |

---

## ai-usage-log.md Entry Format

All AI-assisted work is logged in `docs/ai-usage-log.md`.
...
|------|---------|---------|--------|
| April 24, 2026 | 1.0 | Initial process map | Nemesis Team |

---

*Process Map | Nemesis | CS-PD-2026 | Spring 2026*